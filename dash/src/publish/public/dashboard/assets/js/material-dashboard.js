...
function sidebarColor(a) {
  ...
  if (parent.classList.contains('bg-dark')) {
...
function toggleSidenav() {
  ...
  if (body.classList.contains(className)) {
    ...
    $('.sidenav').parent('div').addClass('d-none d-md-none d-sm-none d-xs-none');
  } else {
    $('.sidenav').parent('div').removeClass('d-none d-md-none d-sm-none d-xs-none');
