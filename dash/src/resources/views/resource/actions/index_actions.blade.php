    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url(app('dash')['DASHBOARD_PATH'].'/resource/'.$resourceName.'/action') }}" method="post">
          ...
          <div class="p-1 actionbtn{{ $resourceName }}">
...
@endpush
<div class="row d-none actions_{{ $resourceName }}">
  <div class="col-8">

    <select name="action{{ $resourceName }}" class="action{{ $resourceName }} form-select {{ app()->getLocale() == 'en'?'ps-2':'' }} form-select-md ">
